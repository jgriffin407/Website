...
<script src="jquery-3.5.0.js"></script>
	<title>Intermediate Addition</title>
	<!--Variables-->
	<script>
...
<ul class="nav nav-pills nav-fill">
  <li class="nav-item dropdown">
    ...
    <div class ="dropdown-menu">
    	...
    	<a class = "dropdown-item disabled" href="intaddition.php">Intermediate</a>
    	<div class = "dropdown-divider"></div>
...
<br/>
	...
	<h1 style="text-align: center; color: #c24b4b;">Intermediate Addition</h1> <br/>
