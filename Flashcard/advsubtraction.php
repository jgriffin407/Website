...
<script src="jquery-3.5.0.js"></script>
	<title>Advanced Subtraction</title>
	<!--Variables-->
	<script>
...
<li class="nav-item dropdown">
    ...
    <div class ="dropdown-menu">
    	...
    	<div class = "dropdown-divider"></div>
    	<a class = "dropdown-item disabled" href="advsubtraction.php">Advanced</a>
    </div>
  </li>
  <li class="nav-item dropdown">
...
<br/>
	...
	<h1 style="text-align: center; color: #c24b4b;">Advanced Subtraction</h1> <br/>
