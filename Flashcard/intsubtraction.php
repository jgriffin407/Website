...
<script src="jquery-3.5.0.js"></script>
	<title>Intermediate Subtraction</title>
	<!--Variables-->
	<script>
...
<li class="nav-item dropdown">
    ...
    <div class ="dropdown-menu">
    	...
    	<div class = "dropdown-divider"></div>
    	<a class = "dropdown-item disabled" href="intsubtraction.php">Intermediate</a>
    	<div class = "dropdown-divider"></div>
...
<br/>
	...
	<h1 style="text-align: center; color: #c24b4b;">Intermediate Subtraction</h1> <br/>
