...
<ul class="nav nav-pills nav-fill">
  <li class="nav-item dropdown">
    ...
    <div class ="dropdown-menu">
    	<a class = "dropdown-item disabled" href="addition.php">Basic</a>
...
<br/>
	...
	<h1 style="text-align: center; color: #c24b4b;">Basic Addition</h1> <br/>
...
<div class="container-sm">
	<input autofocus="" class="form-control" style="text-align: center;" type="tel" id="answer" autocomplete="off" maxlength ="6" size = "6";>
	<br/>
	<br/>
</div>
<div class="container-fluid">
