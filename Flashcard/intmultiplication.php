...
<script src="jquery-3.5.0.js"></script>
	<title>Intermediate Multiplication</title>
	<!--Variables-->
	<script>
...
<li class="nav-item dropdown">
  ...
  <li class="nav-item dropdown">
    ...
    <div class ="dropdown-menu">
    	...
    	<div class = "dropdown-divider"></div>
    	<a class = "dropdown-item disabled" href="intmultiplication.php">Intermediate</a>
    	<div class = "dropdown-divider"></div>
    	<a class = "dropdown-item" href="advmultiplication.php">Advanced</a>
    </div>
  </li>
  <li class="nav-item dropdown">
...
<br/>
	...
	<h1 style="text-align: center; color: #c24b4b;">Intermediate Multiplication</h1> <br/>
...
<br><br/><br/><br/>
<br><br/><br/>
<footer>&copy; Copyright 2020 John Griffin - All Rights Reserved</footer>
